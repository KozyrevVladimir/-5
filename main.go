...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight * r.Duration.Hours())
}
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (speedMS*speedMS/(w.Height/100))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
...
type Swimming struct {
	// добавьте необходимые поля в структуру
	Training
	LengthPool float64 // длина бассейна в м
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	distanceMeters := s.LengthPool * float64(s.CountPool)
